...
export default function Input({ name, type, title, placeholder, minLength, maxLength, isInputValid, value, onChange, error }) {
  ...
  return (
    <>
      <input
        ...
        required
        className={
          `${name='name' || name === 'password' || name === 'email' ? 'login__input' : 'popup__input'}
